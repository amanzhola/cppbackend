...
| ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------ |
| Папка урока                                                              | Практический урок находится здесь: `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files`            | Внутри лежит CMake-проект, исходный код сервера и папка `static` с клиентскими файлами | Урок оформлен отдельной папкой |
...
```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files
```
...
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------- |
| `CMakeLists.txt`                         | Файл находится здесь: `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/CMakeLists.txt` | Он описывает C++ проект, стандарт C++17, исполняемый файл `static_server`, путь к Boost из Conan и подключение `pthread` | Проект собирается через CMake |

```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/CMakeLists.txt
```
...
```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static/index.html
```
...
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| `static/style.css`                  | Файл находится здесь: `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static/style.css` | Этот файл задаёт внешний вид страницы: фон, цвет текста, шрифт, центрирование, внешний вид canvas, рамку и отступы | Страница становится оформленной, а canvas получает визуальные границы |

```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static/style.css
```
...
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `static/app.js`                            | Файл находится здесь: `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static/app.js`      | Код находит canvas, получает 2D-контекст, рисует зелёный квадрат и пишет сообщение в консоль браузера | JavaScript оживляет HTML-страницу и показывает, что скрипт реально загружен |
...
```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static/app.js
```
...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| Неправильный `Static root`                       | Изначально сервер показывал `Static root: "/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/build/static"`, но файлы лежали не там | Правильная папка: `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static`                                                                   | Сервер искал файлы в `build/static`, где их не было |
| Причина ошибки                                   | Ошибка была в строке `fs::path static_root = fs::current_path() / "static";`                                                                        | Потому что сервер запускался из папки `build`, а значит `current_path()` указывал на `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/build` | Поэтому сервер искал `build/static/index.html`      |
...
```text
Static root: "/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/build/static"
```

```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static
```
...
```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/build
```
...
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `src/main.cpp`                                   | Файл находится здесь: `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/src/main.cpp` | Код реализует HTTP-сервер на Boost.Beast, обработку GET-запросов, чтение файлов, определение MIME-типа, проверку безопасности пути, ответы `200 OK`, `403 Forbidden`, `404 Not Found`, `405 Method Not Allowed` | Сервер умеет отдавать статические файлы и защищаться от опасных путей |

```text
/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/src/main.cpp
```
...
| ------------------------------------ | ---------------------------------------------------------------------- | ------------------------------ | --------------------- |
| Перейти в папку проекта              | `cd /home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files` | Открывает корневую папку урока | Готово к сборке       |
...
```bash
cd /home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files
rm -rf build
mkdir build
cd build
cmake ..
...
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------- |
| Запуск из папки build                                | Из папки `/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/build` запустить `./static_server` | Ожидаемый вывод: `Server started: http://localhost:8080` и `Static root: "/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static"` | Если в `Static root` написано `build/static`, значит путь исправлен неправильно | Сервер должен показывать правильный static root |
...
Static root: "/home/ubuntu/cppbackend/lessons/web_server_lesson_18_static_files/static"
```
...
| ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------ | ---------------------------- |
| Создана отдельная папка урока                                    | Практический урок оформлен в отдельной директории `web_server_lesson_18_static_files`    | Это удобно для самостоятельной сборки и проверки       | Папка готова                 |
