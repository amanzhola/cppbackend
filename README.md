...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| [`profiling_applications`](lessons/sprint_19_20/profiling_applications/README.md)                   | Профилирование приложений: поиск узких мест, горячих точек, измерение времени выполнения, инструментирование кода, статистическое профилирование и флеймграфы | Позволяет научиться искать реальные проблемы производительности до начала оптимизации и принимать решения на основе измерений, а не предположений | Освоены базовые и продвинутые методы профилирования |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ---------------- |
| `sprint3/1. Профилирование приложений`                                                                              | Поиск проблем производительности, горячих точек, инструментирование кода, статистическое профилирование и анализ флеймграфов | [README](sprint3/1.%20Профилирование%20приложений/README.md)                     | Навигация готова |
| `sprint3/2. Нагрузочное тестирование проекта`                                                                       | Подготовка сценариев нагрузки, проведение нагрузочных тестов и анализ поведения сервера под высокой нагрузкой                | [README](sprint3/2.%20Нагрузочное%20тестирование%20проекта/README.md)            | Навигация готова |
| `sprint3/3. Тестирование и отладка`                                                                                 | Boost.Test, Google Test, Catch2, TDD, повторное использование тестового кода и практики отладки приложений                   | [README](sprint3/3.%20Тестирование%20и%20отладка/README.md)                      | Навигация готова |
| `sprint3/4. Обработка коллизий и игровая статистика`                                                                | Реализация коллизий, сбор игровой статистики, математические основы пересечений объектов, Catch2 и GDB                       | [README](sprint3/4.%20Обработка%20коллизий%20и%20игровая%20статистика/README.md) | Навигация готова |
