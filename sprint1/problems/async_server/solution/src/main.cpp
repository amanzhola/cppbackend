...
StringResponse HandleRequest(StringRequest&& req) {
    const auto make_ok_response = [&req](std::string_view body) {
    ...
    if (req.method() != http::verb::get && req.method() != http::verb::head) {
        return make_invalid_method_response();
    }
    ...
    std::string body = "Hello, "s + target;

    auto response = make_ok_response(body);
